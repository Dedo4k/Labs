...
;Âûâîä ìàññèâà ñëîâ (word)
;cx - êîëè÷åñòâî âûâîäèìûõ ýëåìåíòîâ
;ds:dx - àäðåñ ìàññèâà ñëîâ
ShowArray proc
        pusha
 
        jcxz @@saExit        ;åñëè ìàññèâ ïóñòîé - çàâåðøèòü
...
invert proc
    pusha
        ...
        for4:
            ...
            idiv bx           ;ax=ax/bx=1/n ax-öåëàÿ dx-îñòàòîê
               
            push ax          ;ñîõðàíÿåì îñòàòîê
            push bx          ;ñîõðàíÿåì äåëèìîå
            push dx          ;ñîõðàíÿåì äåëèòåëü                   
            
            lea dx,ax        ;âûâîä öåëîé ÷àñòè
            call ShowInt16   
            
            mov ah,2         ;âûâîä òî÷êè
            mov dl,'.'
            int 21h
            ...
            push cx          ;ñîõðàíÿåì ñ÷¸ò÷èå ìàññèâà for4
            
            push ax
            push bx
            push dx
            
            mov cx,3         ;êîëè÷åñòâî çíàêîâ ïîñëå çàïÿòîé
            
            for5:
                pop dx       ;âîçâðàùàåì îñòàòîê    1
                pop bx       ;âîçâðàùàåì äåëèìîå    0
                pop ax       ;âîçâðàùàåì äåëèòåëü   3
                                
                mov ax,bx    ;                                bx=ax
                push bx
                xchg ax,dx   ;óâåëè÷èâàåì îñòàòîê â 10 ðàç    dx=3 ax=1            
                mov bx,10    ;                                bx=10
                mul bx
                pop bx
