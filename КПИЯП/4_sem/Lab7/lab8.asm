...
error_message               db "wrong command line argument format", 0Dh, 0Ah, "correct format:", 0Dh, 0Ah, "number_of_repeats[1-255] filename", 0Dh, 0Ah, '$'
...
prep_for_start:
    ...
    cmp bx,1
        je _end
    mov word ptr [command_text],bx
    
    strlen A,B,exec_file_path
    lea si,exec_file_path
    lea di,command_text+2
    rep movsb
