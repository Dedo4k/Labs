...
read:
    ...
    mov cx,ax
    cmp ax,0
        je prep_for_start ;если файл закончился то перейти к запуску
...
init_EPB:
    ...
    ;проверить все ли программы из файла были запущены
    ;jmp get_exec_file
