...
public:
	...
	int numberNode(Node<TYPE>* root);
	void printKey(Node<TYPE>* root, int level);
	void findByKey(Node<TYPE>* root);
	void findByKey(Node<TYPE>* root, int key);
	void deleteByKey(Node<TYPE>* root);
	Node<TYPE>* deleteByKey(Node<TYPE>* root, int key);
	int getPlace(Node<TYPE>* root, int key);
	Node<TYPE>* findMinNode(Node<TYPE>* root);
